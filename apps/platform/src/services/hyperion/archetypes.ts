...
export interface Archetype {
  ...
  lore: string // Additional lore and backstory for the archetype
...
export const ARCHETYPES: Archetype[] = [
  // Foundation Archetypes (2-Trait Requirements)
  {
    ...
    lore: 'In the markets, chaos is just unprocessed data. The Analyst transforms noise into signal, seeing patterns invisible to others. Where most traders react to price movements, the Analyst anticipates them through rigorous analysis and strategic foresight.',
  ...
  },
  {
    ...
    lore: 'Consensus is the enemy of alpha. The Contrarian finds opportunity in crowd psychology, buying fear and selling greed with unwavering confidence. They understand that the greatest profits lie where others fear to tread.',
  ...
  },
  {
    ...
    lore: 'Wealth is not built in bull markets—it survives bear markets. The Guardian masters the art of protection, building impenetrable defenses around capital. Through emotional discipline and long-term thinking, they ensure that today\'s gains become tomorrow\'s legacy.',
  ...
  },
  {
    ...
    lore: 'Ideas without execution are worthless. The Executor transforms strategy into reality with surgical precision. While others hesitate, they move—each action calibrated, each entry timed perfectly, every exit executed without emotion.',
  ...
  },
  {
    ...
    lore: 'The market tests not your intelligence, but your temperament. The Stoic remains unmoved by euphoria and panic alike, making decisions from a place of clarity. They know their biases, control their impulses, and trade with the calm of ancient philosophers.',
  ...
  },
  {
    ...
    lore: 'Yesterday\'s edge is today\'s norm. The Innovator constantly evolves, developing strategies before the market recognizes their value. They combine creative thinking with rapid execution, pioneering approaches that others will copy years later.',
  ...
  },
  {
    ...
    lore: 'Perfection is a direction, not a destination. The Optimizer relentlessly refines every aspect of their trading—entry logic, position sizing, risk controls. Through systematic analysis and flawless execution, they extract maximum returns from every strategy.',
  ...
  },
  {
    ...
    lore: 'Volatility is not risk—it\'s raw material. The Alchemist thrives in chaos, adapting to ever-changing conditions with creative solutions. Market dislocations that panic others become their greatest opportunities for transformation.',
  ...
  },
  {
    ...
    lore: 'Most traders lose money through action. The Sentinel profits through patience, waiting with analytical precision for setups that meet their exact criteria. They understand their edge and only strike when conditions align perfectly.',
  ...
  },
  {
    ...
    lore: 'Convention is the graveyard of alpha. The Maverick breaks rules others don\'t even know exist, executing bold moves with lightning speed. They see opportunities in market structures that traditional thinking can\'t comprehend.',
  ...
  },
  {
    ...
    lore: 'True wealth serves a purpose beyond accumulation. The Sage invests with long-term vision and unwavering principles, understanding that sustainable returns come from integrity. They build portfolios that reflect both financial acumen and ethical conviction.',
  ...
  },
  {
    ...
    lore: 'Markets move in cycles, but the Catalyst creates their own momentum. Through confident action and adaptive learning, they identify inflection points before they\'re obvious. Where others follow trends, the Catalyst initiates them.',
  ...
  // Advanced Archetypes (3-Trait Requirements)
  {
    ...
    lore: 'Specialization has its place, but true resilience comes from balance. The Balanced Investor develops competence across multiple dimensions, creating a diversified skill set that thrives in any market condition. They are the polymaths of portfolio management.',
  ...
  },
  {
    ...
    lore: 'Survival belongs to the adaptable. The Adaptive Trader constantly evolves, learning from every trade and market regime. Through deep self-awareness and rapid execution, they reshape their approach to match whatever the market demands.',
    unlockRequirements: 'Sum of top 3 traits ≥ 10.50, gap ≤ 1.50',
    isUnlocked: false,
    progress: 12,
    tierColor: '#3B82F6'
  },
  {
    ...
    lore: 'The future is not predicted—it\'s constructed through understanding. The Visionary sees market trends before they emerge, combining strategic foresight with analytical rigor. They invest not in what is, but in what will be, protecting capital while positioning for transformation.',
    unlockRequirements: 'Sum of top 3 traits ≥ 10.50, gap ≤ 1.50',
    isUnlocked: false,
    progress: 18,
    tierColor: '#3B82F6'
  },
  {
    ...
    lore: 'Information moves through networks, and networks are built on trust. The Networker understands that trading is fundamentally social, leveraging relationships and information flows with integrity. They adapt to community dynamics while maintaining strategic vision.',
    unlockRequirements: 'Sum of top 3 traits ≥ 10.50, gap ≤ 1.50',
    isUnlocked: false,
    progress: 20,
    tierColor: '#3B82F6'
  },
  {
    ...
    lore: 'Markets are made of humans, and humans are driven by psychology. The Philosopher understands both self and others with profound clarity, trading from a place of wisdom rather than impulse. Their edge is understanding the mind behind the money.',
    unlockRequirements: 'Sum of top 3 traits ≥ 10.50, gap ≤ 1.50',
    isUnlocked: false,
    progress: 8,
    tierColor: '#3B82F6'
  },
  {
    ...
    lore: 'Complex systems require masterful coordination. The Orchestrator manages multiple strategies simultaneously, each position harmonizing with others in service of a larger vision. Through calm execution and strategic foresight, they conduct market symphonies.',
    unlockRequirements: 'Sum of top 3 traits ≥ 10.50, gap ≤ 1.50',
    isUnlocked: false,
    progress: 14,
    tierColor: '#3B82F6'
  },
  {
    ...
    lore: 'Great structures require both vision and foundation. The Architect designs comprehensive trading systems built to last, combining analytical precision with long-term preservation. Every component serves a purpose, every risk is measured, every structure reinforced.',
    unlockRequirements: 'Sum of top 3 traits ≥ 10.50, gap ≤ 1.50',
    isUnlocked: false,
    progress: 10,
    tierColor: '#3B82F6'
  },
  {
    ...
    lore: 'The best traders are students of everything. The Polymath draws insights from analysis, creativity, and foresight, synthesizing knowledge across domains. They are the renaissance minds of modern markets, finding connections others miss.',
    unlockRequirements: 'Sum of top 3 traits ≥ 10.50, gap ≤ 1.50',
    isUnlocked: false,
    progress: 22,
    tierColor: '#3B82F6'
  ...
  // Elite Archetypes (4-Trait Requirements)
  {
    ...
    lore: 'Dominance is not given—it\'s earned and defended. The Sovereign commands markets with multi-dimensional mastery, combining strategic foresight, analytical precision, emotional control, and wealth preservation. They rule their domain not through luck, but through complete competence across all critical dimensions of trading.',
  ...
  },
  {
    ...
    lore: 'Some traders play the game. The Transcendent operates on a higher plane entirely, where self-awareness meets strategic vision and adaptability flows from integrity. They don\'t compete with others—they evolve beyond competition itself, creating value in dimensions others haven\'t discovered.',
    unlockRequirements: 'Sum of top 4 traits ≥ 14.00, gap ≤ 2.00',
    isUnlocked: false,
    progress: 3,
    tierColor: '#9333EA'
  },
  {
    ...
    lore: 'Prophecy is pattern recognition perfected. The Oracle sees futures others cannot imagine through unmatched strategic foresight, analytical depth, and profound self-awareness. They protect what they build because they understand the long game. When the Oracle speaks of what will be, markets listen.',
    unlockRequirements: 'Sum of top 4 traits ≥ 14.00, gap ≤ 2.00',
    isUnlocked: false,
    progress: 2,
    tierColor: '#9333EA'
  },
  {
    ...
    lore: 'Power respects power. The Titan commands markets through overwhelming execution, unshakeable confidence, and calculated precision. Where others see resistance, the Titan sees obstacles to crush. They don\'t adapt to market conditions—they create them through sheer force of disciplined will and flawless action.',
    unlockRequirements: 'Sum of top 4 traits ≥ 14.00, gap ≤ 2.00',
    isUnlocked: false,
    progress: 4,
    tierColor: '#9333EA'
  ...
  // Legendary Archetypes (Perfect Balance)
  {
    ...
    lore: 'Mastery in all things, weakness in none. The Equilibrium achieves what few believe possible—perfect balance across every trading dimension. Not a specialist, not a generalist, but a completely realized trader whose strength lies in having no weakness. From this balance flows infinite adaptability and unshakeable resilience.',
  ...
  },
  {
    ...
    lore: 'Beyond balance lies transcendence. The Singularity represents the ultimate convergence of all trading mastery—every trait maximized, every dimension perfected, every capability realized. They are the event horizon of trading evolution, where individual skills collapse into something entirely new. Few will ever reach this state, and fewer still can comprehend it.',
